...
module.exports = {
    ...
    BOTPLK: process.env.BOT_NAME === undefined ? 'Devu-Mwol BOT' : process.env.BOT_NAME,
    ...
    CAPTION_KEY: process.env.CAPTION_KEY === undefined ?'Made by Devu-Mwol' : process.env.CAPTION_KEY,
    ...
    SUPPORT: "919567274241-1610633270",
